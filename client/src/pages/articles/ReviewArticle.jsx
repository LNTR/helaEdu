      ...
      {loadingState && (
        ...
        <div className="dashboard-wrapper mb-9">
          ...
          <div className="content-wrapper mx-32 ">
            <div
              className={`${
                isModalOpen || isDeclineModalOpen ? "modalOpen" : ""
              }`}
            >
              <div className="">
              ...
              <div className="flex justify-between">
                  ...
                  <div className="p-10">
                    ...
                    <div className="flex flex-wrap">
                      {article.tags &&
                        article.tags.map((tag, index) => (
                          <div
                            key={index}
                            className="border-none text-gray1 text-2xl px-2 py-1 mr-2 mb-2"
                          >
                            #{tag}
                          </div>
                        ))}
                    ...
                    <div className="flex justify-start mt-7">
                      <div className="rounded-xl m-2 flex items-center">
                        <FontAwesomeIcon
                          icon={faFile}
                          className="text-4xl hover:text-yellow cursor-pointer hover:translate-x-1"
                          style={{ color: "#6C6C6C" }}
                        />
                        <a
                          href={article.additionalFilesRefs}
                          download
                          className="text-2xl text-gray1 hover:text-yellow cursor-pointer ml-2"
                        >
                          {article.additionalFilesRefs
                            ? "Download File"
                            : "No File Available"}
                        </a>
                      </div>
                ...
                <div className="w-3/12  items-center">
                  ...
                  <button
                    className="bg-blue text-xl text-white py-2 px-4 rounded w-52 h-16 hover:translate-x-2 mb-4"
                    onClick={openModal}
                  >
                    Approve Article
                  </button>
                  <br></br>
                  <button
                    className="bg-red-500 text-white text-xl py-2 px-4  w-52 h-16 rounded hover:translate-x-2"
