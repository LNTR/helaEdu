          ...
          <div className='flex justify-center p-2 w-auto'>
            <div className="card bg-base-100 w-128 shadow-xl m-6">
              <div className="card-body">
                <h2 className="card-title text-header1">Pending Articles</h2>
            ...
            <div className="card bg-base-100 w-128 shadow-xl m-6">
              <div className="card-body">
                <h2 className="card-title text-header1">Reviewed Articles</h2>
                <p className='text-1 text-gray1 pt-4'>Reviewed list of articles by you</p>
                <div className="card-actions justify-start mt-8">
                  <button className="btn border-none text-white bg-blue shadow-lg w-28 hover:text-black hover:bg-yellow" onClick={() => handleCardClick("articles/reviewedArticleListByMod")}>View</button>
                </div>
              </div>
            </div>
            <div className="card bg-base-100 w-128 shadow-xl m-6">
